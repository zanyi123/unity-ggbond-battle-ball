// ================================================================
// 决竞球 CLEAN_v2 合法骨架: IllusionManager.cs [BattleBall.Battle.Physics]
...
namespace BattleBall.Battle.Physics
{
    ...
    {
        public List<Transform> illusions = new List<Transform>();
        ...
        public virtual Transform SpawnIllusion(Transform origin, Vector3 offset) {
            var go = new GameObject("Illusion_"+origin.name);
            go.transform.SetPositionAndRotation(origin.position+offset, origin.rotation);
            illusions.Add(go.transform); return go.transform;
        }
        public virtual void ClearAll() { foreach (var t in illusions) if (t) Destroy(t.gameObject); illusions.Clear(); }
    }
